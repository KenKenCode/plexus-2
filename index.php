...
<head>
  ...
  <title>Plexus Technology Corporation Website</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/ptc-icon.png" rel="icon">
  <link href="assets/img/ptc-icon.png" rel="apple-touch-icon">
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">SALES@PLEXUSTEC.NET</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>0976 462 8759</span></i>
      </div>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <h1>Welcome to <span>Plexus Technology Corporation</span></h1>
      <h2>We strive to drive progress in the digital age</h2>
      <div class="d-flex">
        <a href="#about" class="btn-get-started scrollto">Get Started</a>
        <a href="https://youtu.be/McepeMkd4bE" class="glightbox btn-watch-video"><i class="bi bi-play-circle" style="color: #00ff2a;"></i><span>Watch Video</span></a>
      </div>
    </div>
  </section><!-- End Hero -->
      ...
      <section id="clients" class="clients section-bg">
        <div class="container" data-aos="zoom-in">
          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="assets/img/clients/client-2.png" class="img-fluid" alt=""> <a href=""></a>
            </div>
  
            <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="assets/img/clients/client-3.png" class="img-fluid" alt=""> <a href=""></a>
            </div>
  
            <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="assets/img/clients/client-4.png" class="img-fluid" alt=""> <a href=""></a>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <h3>Plexus Technology Corporation is a provider of advanced technology solutions</h3>
            <p class="fst-italic">
              Specializing in computer hardware, software, IT security, and network components for businesses and individuals.
            </p>
            <ul>
              <li>
                ...
                <div>
                  <h5>Mission</h5>
                  <p>To be a trusted partner, guiding our clients through the complexities of technology, while fostering a culture of continuous learning and innovation within our team.</p>
                </div>
              </li>
              <li>
                <i class="bi bi-eye"></i>
                <div>
                  <h5>Vision</h5>
                  <p>To deliver products and services tailored to meet each customer's distinct needs and ensure timely fulfillment of our commitments.</p>
                </div>
              </li>
            </ul>
            <p>
              We also provide consultation and training to support clients in navigating the digital landscape.
              Committed to innovation, reliability, and customer satisfaction,
              we strive to drive progress in the digital age.
            </p>
          </div>
        </div>
    ...
    <section id="team" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Get to know the passionate individuals who drive our success:</p>
        </div>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-12">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Lot 28 Blk 3 Eusebio Avenue, San Miguel
                1600 City of Pasig, NCR Second District
                Philippines</p>
            </div>
          </div>
...
<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Plexus Technology Corporation<span>.</span></h3>
            <p>
              Lot 28 Blk 3 Eusebio Avenue, San Miguel <br>
              1600 City of Pasig, NCR Second District<br>
              Philippines <br><br>
              <strong>Phone:</strong> 0976 462 8759<br>
              <strong>Email:</strong> SALES@PLEXUSTEC.NET<br>
            </p>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Plexus Technology Corporation</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short" style="color: #00ff2a;"></i></a>
  ...
  <script>
    $(document).ready(function() {
        $('#showProductVideoWall').click(function() {
